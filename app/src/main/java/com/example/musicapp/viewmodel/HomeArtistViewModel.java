...
public class HomeArtistViewModel extends ViewModel {
  ...
  private final HomeArtistFragment.SpotifyApiService apiService;
  private final List<String> artistIdArray;
  ...
  public void fetchArtists(String accessToken) {
    ...
    for (String artistId : artistIdArray) {
      Call<HomeArtistFragment.ArtistsResponse> call =
          apiService.getRelatedArtists(authorization, artistId);
      call.enqueue(
          new Callback<HomeArtistFragment.ArtistsResponse>() {
            @Override
            public void onResponse(
                Call<HomeArtistFragment.ArtistsResponse> call,
                Response<HomeArtistFragment.ArtistsResponse> response) {
            ...
            public void onFailure(
                Call<HomeArtistFragment.ArtistsResponse> call, Throwable throwable) {
